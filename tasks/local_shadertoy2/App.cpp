  ...
  , textureResolution{128, 128}
{
...

  {
    ...
    image = etna::create_image_from_bytes(
      textureInfo, etna::get_context().createOneShotCmdMgr()->start(), texture);
  ...
  if (nextSwapchainImage)
  {
    ...
    ETNA_CHECK_VK_RESULT(currentCmdBuf.begin(vk::CommandBufferBeginInfo{}));
    {
...

      {
        ...
        glm::uvec2 params = textureResolution;
